...
This file applies when Claude is working in `remittance-stub-parsing/tests/`.
...
- Bad: `test_function_1`, `tests parse_config`.
- Good: `test_parses_config_when_file_has_trailing_comma`, `test_returns_empty_list_when_input_is_null`.
