...
Anchor to Cinderhaven's existing numbers (6,563 chargebacks / 36 months, $3.7M/yr all-in trade spend, 11.3% of scan revenue). Frame three layers:
...
- **Reuses** the deduction/chargeback records already built (6,563 chargebacks, $3.7M/yr all-in trade spend). The stubs are a new *view* of money already in the dataset, not new money.
...
- Reconcile to the existing Cinderhaven numbers — do not let parsed totals drift from the canonical $3.7M/yr all-in trade spend.
