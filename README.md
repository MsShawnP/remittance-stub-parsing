...
- Reconciliation against Cinderhaven SSOT: 3,363 chargebacks (2,879 retailer + 484 distributor), ~$3.6M/yr all-in trade cost, 36-month window.
...
Reconciliation uses the canonical 3,363 chargebacks (2,879 retailer + 484 distributor) and ~$3.6M/yr all-in trade cost from cinderhaven-data-platform.
