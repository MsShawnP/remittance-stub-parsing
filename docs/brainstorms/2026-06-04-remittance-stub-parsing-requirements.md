...
- R2. Stubs must reconcile against the Cinderhaven SSOT in Postgres (464 chargebacks, $5.4M all-in trade cost) — parsed totals must not drift from canonical figures
...
- R20. Recoverable dollar figure is derived from the Cinderhaven data during the build — anchored against the $5.4M all-in trade cost, framing recovery, labor savings, and dispute-window forfeit
...
- AE5. **Covers R2, R20.** The reconciled ledger totals tie exactly to the Cinderhaven canonical $5.4M all-in trade cost figure — no drift.
...
- The 464 chargebacks and $5.4M all-in trade cost figures are current and canonical
...
- [Affects R20][Technical] Derivation of the recoverable dollar figure from Cinderhaven data — what's the plausible recovery rate against the $5.4M base
