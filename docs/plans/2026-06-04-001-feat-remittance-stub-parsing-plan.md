...
- **Recoverable figure:** Derive from the reconciled data — sum of invalid/disputable deductions that are still within the dispute window, anchored against the ~$380K/yr operational deduction waste
...
- Covers AE5. Ledger totals tie exactly to Cinderhaven canonical ~$3.6M/yr all-in trade spend
